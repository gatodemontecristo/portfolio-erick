...
export const TimeLine = ({ items, className, title }: TimeLineProps) => {
  return (
    <div className="flex flex-col w-full items-center  justify-center gap-12 md:mt-10 mt-4">
      <TextType
        text={[title]}
        typingSpeed={75}
        pauseDuration={1500}
        ...
        loop={false}
        className="text-magazine-gray md:text-6xl text-3xl font-extrabold text-center"
      />
